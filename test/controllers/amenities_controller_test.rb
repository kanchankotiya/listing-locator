...
class AmenitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amenity" do
    assert_difference('Amenity.count') do
      post amenities_url, params: { amenity: { amenity_icon: @amenity.amenity_icon, amenity_name: @amenity.amenity_name } }
    end
  ...
  test "should update amenity" do
    patch amenity_url(@amenity), params: { amenity: { amenity_icon: @amenity.amenity_icon, amenity_name: @amenity.amenity_name } }
